...
ISO CHAR(2) NOT NULL,			
PAIS VARCHAR(30) NOT NULL														COMMENT 'CAMPO QUE ALMACENA EL NOMBRE DEL PAIS'
)ENGINE=INNODB
CHARACTER SET UTF8
...
FECHA DATETIME NOT NULL															COMMENT 'CAMPO QUE ALMACENA LA FECHA DE LA FACTURA',
CANT_ASIENTOS INT NOT NULL														COMMENT 'CAMPO QUE DESCRIBE LA CANTIDAD DE ASIENTOS',
TIPO_PAGO VARCHAR(20) NOT NULL													COMMENT 'CAMPO QUE DESCRIBE EL TIPO DE PAGO REALIZADO',
...
SINOPSIS VARCHAR(100) NOT NULL													COMMENT 'BREVE DESCRIPCION DE LA PELICULA',
PORTADA MEDIUMBLOB NOT NULL														COMMENT 'IMAGEN DE LA PELICULA',				
...
IDIOMA VARCHAR(25) NOT NULL														COMMENT 'IDIOMA PELICULA'			
)ENGINE=INNODB
CHARACTER SET UTF8
COLLATE=UTF8_UNICODE_CI;

CREATE TABLE SUBTITULO(
ID_SUB INT PRIMARY KEY AUTO_INCREMENT											COMMENT 'LLAVE PRIMERIA, SE INCREMENTA AUTOMATICAMENTE',
SUBTITULO VARCHAR(25) NOT NULL													COMMENT 'SUBTITULO PELICULA'
)ENGINE=INNODB
CHARACTER SET UTF8
COLLATE=UTF8_UNICODE_CI;
...
ID_SUB INT																		COMMENT 'LLAVE FORANEA, QUE HACE REFERENCIA A LA TABLA SUBTITULO',
...
PRECIO FLOAT (1.2) NOT NULL														COMMENT 'CAMPO QUE DESCRIBE EL PRECIO DE LA PELICULA',
...
CONSTRAINT CARTELERA_ID_SUB_FK FOREIGN KEY (ID_SUB) REFERENCES SUBTITULO (ID_SUB),
...
DESCUENTO FLOAT (1.2) NOT NULL													COMMENT '% DE DESCUENTO DE LA PROMOCION',
ID_ESTADO INT																	COMMENT 'LLAVE FORANEA QUE HACE REFERENCIA A LA TABLA ESTADO',
CONSTRAINT PROMOCION_ID_ESTADO_FK FOREIGN KEY (ID_ESTADO) REFERENCES ESTADO (ID_ESTADO)
)ENGINE=INNODB
CHARACTER SET UTF8
COLLATE=UTF8_UNICODE_CI;
...
FECHA DATE NOT NULL																COMMENT 'CAMPO QUE DESCRIBE LAS FECHAS DE PROMOCIÓN',
ID_PROMO INT																	COMMENT 'LLAVE FORANEA QUE HACE REFERENCIA A LA TABLA PROMOCION',
ID_ESTADO INT																	COMMENT 'LLAVE FORANEA QUE HACE REFERENCIA A LA TABLA ESTADO',
CONSTRAINT PROGRAMACION_ID_PROMO_FK FOREIGN KEY (ID_PROMO) REFERENCES PROMOCION (ID_PROMO),
CONSTRAINT PPROGRAMACION_ID_ESTADO_FK FOREIGN KEY (ID_ESTADO) REFERENCES ESTADO (ID_ESTADO)
)ENGINE=INNODB
CHARACTER SET UTF8
COLLATE=UTF8_UNICODE_CI;
