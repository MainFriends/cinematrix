...
CREATE PROCEDURE SP_UPD_PELICULA(
		...
		UPDATE PELICULA
        SET TITULO = _TITULO, SINOPSIS = _SINOPSIS, DURACION = _DURACION, REPARTO = _REPARTO, DIRECTOR = _DIRECTOR, AÑO = _AÑO, ID_GENERO = _ID_GENERO, ID_CLASIFICACION = _ID_CLASIFICACION, ID_ESTADO = _ID_ESTADO
