...
CREATE PROCEDURE SP_LOGIN_USUARIO(
		...
		SELECT ID_ROL, NOMBRE, APELLIDO FROM LOGIN, USUARIO WHERE LOGIN.ID_USUARIO = USUARIO.ID_USUARIO
...
CREATE PROCEDURE SP_ADD_PELICULA(
        ...
        VALUES (_TITULO, _DURACION, _ID_GENERO, _ID_CLASIFICACION, _AÑO, _SINOPSIS, _PORTADA, _ID_ESTADO);
...
CREATE PROCEDURE SP_UPD_PELICULA(
		...
		UPDATE PELICULA
        SET TITULO = _TITULO, DURACION = _DURACION, ID_GENERO = _ID_GENERO, ID_CLASIFICACION = _ID_CLASIFICACION, AÑO = _AÑO, SINOPSIS = _SINOPSIS, ID_ESTADO = _ID_ESTADO
...
CREATE PROCEDURE SP_ADD_CARTELERA(
        ...
        VALUES (_IDPELICULA, _IDSALA, _HORAINICIO, _HORAFIN, _IDIDIOMA, _IDSUBTITULO, _IDFORMATO, _FECHA, _PRECIO);
...
CREATE PROCEDURE SP_UPD_CARTELERA(
		...
		UPDATE CARTELERA
        SET ID_PELICULA = _IDPELICULA, ID_SALA = _IDSALA, HORA_INICIO = _HORAINICIO, HORA_FIN = _HORAFIN, ID_IDIOMA = _IDIDIOMA, ID_SUB = _IDSUBTITULO, ID_FORMATO = _IDFORMATO, FECHA = _FECHA, PRECIO = _PRECIO
...
CREATE PROCEDURE SP_ADD_PROMO(
        ...
        VALUES (_NOMBRE, _DESCUENTO, _IDESTADO);
...
CREATE PROCEDURE SP_UPD_PROMO(
		...
		UPDATE PROMOCION
        SET NOMBRE = _NOMBRE, DESCUENTO = _DESCUENTO, ID_ESTADO = _IDESTADO
...
CREATE PROCEDURE SP_ADD_PPROMO(
        ...
        VALUES (_FECHA, _IDPROMO, _IDESTADO);
...
CREATE PROCEDURE SP_UPD_PPROMO(
        ...
        SET FECHA = _FECHA, ID_PROMO = _IDPROMO, ID_ESTADO = _IDESTADO
