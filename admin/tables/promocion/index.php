      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card text-left">
            ...
            <div class="card-body">
              <button class="btn btn-danger rounded-pill" id="addPromo"><i class="fas fa-plus me-2"></i>Agregar nuevo</button>
              <hr>
              <div class="table-responsive">
                <table class="table table-striped table-hover table-bordered" id="tablaPromo" style="width:100%">
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <p>¿Esta seguro que desea eliminar esta promoción? </p>
      </div>
      <div class="modal-footer">
